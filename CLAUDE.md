...
- SCORM trial backport punchlist and acceptance gates: [docs/SCORM_TRIAL_PUNCHLIST.md](docs/SCORM_TRIAL_PUNCHLIST.md)
- SCORM trial backport implementation matrix: [docs/SCORM_BACKPORT_MATRIX.md](docs/SCORM_BACKPORT_MATRIX.md)
- Production transition plan (Phase 1 backport → Phase 2 LMS architecture → Phase 3 Render changeover): [docs/PRODUCTION_TRANSITION_PLAN.md](docs/PRODUCTION_TRANSITION_PLAN.md)
- GBL principles, instructional design rules, and improvement roadmap: [docs/LEARNING_DESIGN.md](docs/LEARNING_DESIGN.md)
- Product improvement direction, two-mode strategy, and content expansion plan: [docs/PRODUCT_IMPROVEMENT_DIRECTION.md](docs/PRODUCT_IMPROVEMENT_DIRECTION.md)
- QA/QI readiness requirements and gaps (separate from SaaS hardening): [docs/QAQI_READINESS.md](docs/QAQI_READINESS.md)
- Scoring improvement sprint plan and implementation checklist: [docs/SCORING_IMPROVEMENT_PLAN.md](docs/SCORING_IMPROVEMENT_PLAN.md)
- Scoring hardening roadmap and per-scenario authoring checklist: [docs/SCORING_HARDENING_ROADMAP.md](docs/SCORING_HARDENING_ROADMAP.md)
- Phased implementation checklist (learning system features): [docs/IMPLEMENTATION_PLAN.md](docs/IMPLEMENTATION_PLAN.md)
- CE certification design and future-readiness reference: [docs/CE_CERTIFICATION_DESIGN.md](docs/CE_CERTIFICATION_DESIGN.md)
- Professionalism scoring framework (NASEMSO affective domain mapping): [docs/PROFESSIONALISM_FRAMEWORK.md](docs/PROFESSIONALISM_FRAMEWORK.md)
