...
MINIGAME_METADATA: dict[str, dict[str, Any]] = {
    ...
    "cpr_bls_sequence": {
        "display_name": "CPR Mastery: Chain of Survival",
        ...
        "reference_card": {
            ...
            "unlock_condition": {"all_passed": ["cpr_bls_concepts"]},
            "content_schema": ["framework_summary", "common_traps", "field_examples", "review_status"],
        },
        "pass_threshold": {"score_gte": 70},
        "mastery_flow": None,
        "adaptive_next_step": "Use as optional reinforcement for BLS sequence ordering after the Station 1 CPR metrics drill.",
    },
    "cpr_bls_concepts": {
        "display_name": "CPR Mastery: Key Metrics",
        ...
        "pass_threshold": {"score_gte": 70},
        "mastery_flow": None,
        "adaptive_next_step": "After proficiency, mark the Station 1 CPR drill complete and unlock the CPR reference card.",
    },
    "shock_spotter_med": {
