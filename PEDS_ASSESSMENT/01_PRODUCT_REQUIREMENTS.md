...
- SCORM pass challenge and final score: 2 PM1 + 2 PT1 passing/on-track scenarios, 60 minutes of eligible training time, and 1200 XP; `scenario_avg` is written as the LMS raw score when complete
